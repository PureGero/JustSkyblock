...
public class Rank {
	public static ArrayList<Rank> all = new ArrayList<Rank>();
	...
	private static HashMap<UUID,PermissionAttachment> attachs = new HashMap<UUID,PermissionAttachment>();
	public static void giveRank(Player p, Rank r){
		...
		if(m == null){
			m = p.addAttachment(SkyBlock.skyblock);
